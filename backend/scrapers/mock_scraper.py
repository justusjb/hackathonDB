...
class MockScraper(BaseScraper):
    ...
    def scrape(self) -> List[InboxItem]:
        ...
        duplicate_url = "https://example.com/duplicate-hackathon"
        ...
        mock_data = [
            ...
            InboxItem(
                ...
                location="Virtual",
                url="https://example.com/mockhacks-alpha",
                notes="First test event from mock.",
                source_url="https://mocksource.com/events",
            ...
            InboxItem(
                ...
                url="https://example.com/fakeconf-beta",
                source_url="https://mocksource.com/events",
                scraper_name=self.SCRAPER_NAME,
            ...
            # 5. Item with Missing Optional Data
             InboxItem(
                ...
                url="https://example.com/minimal-delta",
